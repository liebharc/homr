...
class TestStaffRegions(unittest.TestCase):
    def test_staff_above(self) -> None:
        ...
        self.assertEqual(0, regions.get_start_of_closest_staff_above(199))
        self.assertEqual(0, regions.get_start_of_closest_staff_above(200))
    ...
    def test_staff_below(self) -> None:
        ...
        self.assertEqual(300, regions.get_start_of_closest_staff_below(100))
        self.assertEqual(300, regions.get_start_of_closest_staff_below(101))
        self.assertEqual(500, regions.get_start_of_closest_staff_below(350))
