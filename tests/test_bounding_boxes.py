...
class TestBoundingBoxes(unittest.TestCase):
    ...
    def test_partial_overlap(self):
        box1 = BoundingBox((10, 10, 50, 50), contours=None)
        box2 = BoundingBox((30, 30, 70, 70), contours=None)
    ...
    def test_no_overlap(self):
        box1 = BoundingBox((10, 10, 50, 50), contours=None)
        box3 = BoundingBox((100, 100, 150, 150), contours=None)
        overlap_area = box1.get_overlapping_area_size(box3)
        self.assertEqual(overlap_area, 0)

    def test_full_overlap(self):
        box1 = BoundingBox((10, 10, 50, 50), contours=None)
        box4 = BoundingBox((10, 10, 50, 50), contours=None)
